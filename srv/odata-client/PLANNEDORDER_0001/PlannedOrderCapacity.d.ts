...
import { AllFields, CollectionField, CustomFieldV4, EdmTypeField, EntityBuilderType, EntityV4, Field, OneToOneLink, OrderableEdmTypeField, Time } from '@sap-cloud-sdk/core';
/**
 * This class represents the entity "PlannedOrderCapacity" of service "com.sap.gateway.srvd_a2x.api_plannedorder.v0001".
 */
export declare class PlannedOrderCapacity extends EntityV4 implements PlannedOrderCapacityType {
    /**
...
export declare namespace PlannedOrderCapacity {
    /**
     * Static representation of the [[plannedOrder]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const PLANNED_ORDER: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[capacityRequirement]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CAPACITY_REQUIREMENT: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[capacityRequirementItem]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CAPACITY_REQUIREMENT_ITEM: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[capacityRqmtItemCapacity]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CAPACITY_RQMT_ITEM_CAPACITY: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[plannedOrderType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const PLANNED_ORDER_TYPE: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[sequence]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const SEQUENCE: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[operation]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[subOperation]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const SUB_OPERATION: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[workCenter]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const WORK_CENTER: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[capacityCategoryCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CAPACITY_CATEGORY_CODE: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[capacity]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CAPACITY: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[mrpController]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MRP_CONTROLLER: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[mrpPlant]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const MRP_PLANT: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[operationLatestStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION_LATEST_START_DATE: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Date", true, true>;
    /**
     * Static representation of the [[operationLatestStartTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION_LATEST_START_TIME: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.TimeOfDay", false, true>;
    /**
     * Static representation of the [[operationLatestEndDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION_LATEST_END_DATE: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Date", true, true>;
    /**
     * Static representation of the [[operationLatestEndTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION_LATEST_END_TIME: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.TimeOfDay", false, true>;
    /**
     * Static representation of the [[operationEarliestStartDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION_EARLIEST_START_DATE: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Date", true, true>;
    /**
     * Static representation of the [[operationEarliestStartTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION_EARLIEST_START_TIME: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.TimeOfDay", false, true>;
    /**
     * Static representation of the [[operationEarliestEndDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION_EARLIEST_END_DATE: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Date", true, true>;
    /**
     * Static representation of the [[operationEarliestEndTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION_EARLIEST_END_TIME: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.TimeOfDay", false, true>;
    /**
     * Static representation of the [[opLtstSchedldProcgStrtDte]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OP_LTST_SCHEDLD_PROCG_STRT_DTE: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Date", true, true>;
    /**
     * Static representation of the [[opLtstSchedldProcgStrtTme]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OP_LTST_SCHEDLD_PROCG_STRT_TME: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.TimeOfDay", false, true>;
    /**
     * Static representation of the [[opLtstSchedldTrdwnStrtDte]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OP_LTST_SCHEDLD_TRDWN_STRT_DTE: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Date", true, true>;
    /**
     * Static representation of the [[opLtstSchedldTrdwnStrtTme]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OP_LTST_SCHEDLD_TRDWN_STRT_TME: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.TimeOfDay", false, true>;
    /**
     * Static representation of the [[scheduledBasicEndTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const SCHEDULED_BASIC_END_TIME: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.TimeOfDay", false, true>;
    /**
     * Static representation of the [[scheduledBasicStartTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const SCHEDULED_BASIC_START_TIME: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.TimeOfDay", false, true>;
    /**
     * Static representation of the [[capacityRequirementUnit]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const CAPACITY_REQUIREMENT_UNIT: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[unitOfMeasureIsoCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const UNIT_OF_MEASURE_ISO_CODE: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[scheduledCapReqOpSegSetupDurn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const SCHEDULED_CAP_REQ_OP_SEG_SETUP_DURN: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Double", false, true>;
    /**
     * Static representation of the [[remainingCapReqOpSegSetupDurn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const REMAINING_CAP_REQ_OP_SEG_SETUP_DURN: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Double", false, true>;
    /**
     * Static representation of the [[scheduledCapReqOpSegProcgDurn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const SCHEDULED_CAP_REQ_OP_SEG_PROCG_DURN: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Double", false, true>;
    /**
     * Static representation of the [[remainingCapReqOpSegProcgDurn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const REMAINING_CAP_REQ_OP_SEG_PROCG_DURN: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Double", false, true>;
    /**
     * Static representation of the [[scheduledCapReqOpSegTrdwnDurn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const SCHEDULED_CAP_REQ_OP_SEG_TRDWN_DURN: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Double", false, true>;
    /**
     * Static representation of the [[remainingCapReqOpSegTrdwnDurn]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const REMAINING_CAP_REQ_OP_SEG_TRDWN_DURN: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.Double", false, true>;
    /**
     * Static representation of the [[wrkCtrHasLeadingCapacity]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const WRK_CTR_HAS_LEADING_CAPACITY: EdmTypeField<PlannedOrderCapacity, "Edm.Boolean", false, true>;
    /**
     * Static representation of the [[operationText]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const OPERATION_TEXT: EdmTypeField<PlannedOrderCapacity, "Edm.String", false, true>;
    /**
     * Static representation of the [[plannedOrderLastChangeDateTime]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const PLANNED_ORDER_LAST_CHANGE_DATE_TIME: OrderableEdmTypeField<PlannedOrderCapacity, "Edm.DateTimeOffset", true, true>;
    /**
     * Static representation of the [[sapMessages]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const SAP_MESSAGES: CollectionField<PlannedOrderCapacity, Sap_Message, false, true>;
    /**
     * Static representation of the one-to-one navigation property [[plannedOrder_1]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const PLANNED_ORDER_1: OneToOneLink<PlannedOrderCapacity, PlannedOrderHeader>;
    /**
     * All fields of the PlannedOrderCapacity entity.
     */
    const _allFields: Array<EdmTypeField<PlannedOrderCapacity, 'Edm.String', false, true> | OrderableEdmTypeField<PlannedOrderCapacity, 'Edm.Date', true, true> | OrderableEdmTypeField<PlannedOrderCapacity, 'Edm.TimeOfDay', false, true> | OrderableEdmTypeField<PlannedOrderCapacity, 'Edm.Double', false, true> | EdmTypeField<PlannedOrderCapacity, 'Edm.Boolean', false, true> | OrderableEdmTypeField<PlannedOrderCapacity, 'Edm.DateTimeOffset', true, true> | CollectionField<PlannedOrderCapacity, Sap_Message, false, true> | OneToOneLink<PlannedOrderCapacity, PlannedOrderHeader>>;
    /**
     * All fields selector.
     */
    const ALL_FIELDS: AllFields<PlannedOrderCapacity>;
    /**
     * All key fields of the PlannedOrderCapacity entity.
     */
    const _keyFields: Array<Field<PlannedOrderCapacity, boolean, boolean>>;
    /**
     * Mapping of all key field names to the respective static field property PlannedOrderCapacity.
     */
    const _keys: {
        [keys: string]: Field<PlannedOrderCapacity, boolean, boolean>;
    };
}
//# sourceMappingURL=PlannedOrderCapacity.d.ts.map